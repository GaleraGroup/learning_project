...
/***/ "./js/modules/calc_second_edittion.js":
/*!********************************************!*\
  !*** ./js/modules/calc_second_edittion.js ***!
  \********************************************/
...
function calc() {
  var calcFields = document.querySelector('.calculating__field'),
  ...
  var activeClass = 'calculating__choose-item_active';
  ...
  storage.setItem('total', 0); //Перебор всех полей формы калькулятора, с целью вычленения
  //кнопок

  function bruteForceFields() {
    var _iterator = _createForOfIteratorHelper(calcFields.children),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (field.classList.contains('calculating__choose')) {
          var _iterator2 = _createForOfIteratorHelper(field.children),
              _step2;
  ...
  function changeActivity(item) {
    ...
    try {
      var _loop = function _loop() {
        ...
        child.addEventListener('keyup', function (evt) {
  ...
  function setClass(item, child) {
    Array.from(item.children).forEach(function (div) {
  ...
  function setEventButton(parent) {
    ...
    try {
      for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
        ...
        _child.addEventListener('keyup', function (evt) {
          if (evt.code === 'Tab') {
            var e = evt.target;
        ...
        _child.addEventListener('keyup', renderTotalResult);
      }
    } catch (err) {
      _iterator5.e(err);
    } finally {
  ...
  function saveDataToStorage() {} // Сохранение значения из полей с весом, возрастом и ростом в localStorage
  ...
  var User = function User(name, height, weight, age, total, day, userAgent) {
  ...
  function renderBtn() {
    ...
    saveBtn.addEventListener('click', function (evt) {
      ...
      var newUser = new User(checkName(), storage.height, storage.weight, storage.age, storage.total, new Date(), window.navigator.userAgent);
      var json = JSON.stringify(newUser);
      (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.postData)(url, json).then(function (data) {//console.log(data)
      });
    });
...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_7__.getResFromDB)(url).then( /*#__PURE__*/function () {
...
function modal() {
  ...
  var btnModalOpener = document.querySelectorAll('[data-modal]'),
      modal = document.querySelector('.modal'),
      modalCrossBtn = document.querySelector('.modal__close');
  btnModalOpener.forEach(function (btn) {
  ...
  var formModalDialog = document.querySelectorAll('form');
  var msg = {
    loading: 'img/form/spinner.svg',
    success: 'Спасибо, мы скоро с вами свяжемся!',
    failure: 'Ошибка'
  };
  formModalDialog.forEach(function (form) {
    bindPostData(form);
  });

  function bindPostData(form) {
    form.addEventListener('submit', function (evt) {
      evt.preventDefault(); // Спиннер, loading

      var statusMsg = document.createElement('img');
      statusMsg.src = msg.loading;
      statusMsg.classList.add('status');
      form.insertAdjacentElement('afterend', statusMsg);
      var formData = new FormData(form); // const obj = {};
  ...
  function showThanksModal(msg) {
    ...
    thanksModal.innerHTML = "\n            <div class=\"modal__content\">\n            <form action=\"#\">\n                <div class=\"modal__close\">&times;</div>\n                <div class=\"modal__title\">".concat(msg, "</div>\n            </form>\n            ");
...
function slider(_ref) {
  ...
  var sliderContainer = document.querySelector(container),
      ...
      width = window.getComputedStyle(sliderContainer).width; //Переменные переключателя карусели

  var carousel = document.querySelector(indicators); //Остальные переменные

  var offset = 0;
  var index = 1;
  var url = 'http://localhost:3000/sliderItems'; //Установка CSS значений
  ...
  getImg(url).then( /*#__PURE__*/function () {
            ...
            case 3:
              ...
              right.addEventListener('click', function (evt) {
                ...
                if (index >= 1 && index <= imgList.length - 1) {
                  ++index;
                  current.textContent = "".concat(nullAdder(index));
                } else {
                  index = 1;
                  current.textContent = "".concat(nullAdder(index));
                }
              ...
              dots.forEach(function (dot) {
                dot.addEventListener('click', function (evt) {
                  var slideTo = evt.target.getAttribute('data-slide-to');
                  index = slideTo;
...
function tabs(tabHeader, tabHeaderItem, tabContent, tabHeaderActiveClass) {
  var tabsParent = document.querySelector(tabHeader),
      tabs = document.querySelectorAll(tabHeaderItem),
      tabsContent = document.querySelectorAll(tabContent);
  var visibilitySwitch = {
    ...
    showTabContent: function showTabContent() {
      var i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      tabsContent[i].style.display = 'block';
      tabsContent[i].classList.add('fade');
      tabs[i].classList.add(tabHeaderActiveClass.slice(1));
    },
    hideClassActive: function hideClassActive() {
      tabs.forEach(function (tab) {
        tab.classList.remove(tabHeaderActiveClass.slice(1));
      });
    },
    showClassActive: function showClassActive(event) {
...
function timer(d, h, m, s, promoClass, promorTitle, endActionDate) {
  var timerDays = document.querySelector(d),
  ...
  var timeArray = [timerDays, timerHours, timerMinutes, timerSeconds];
  ...
  function getDiffTimeRange(endTime) {
    ...
    var timerValues = [days, hours, minutes, seconds];
  ...
  function renderTimer(arr) {
    var tempTimeArr = getDiffTimeRange(endActionDate);
    tempTimeArr.map(function (item) {
      return String(item);
    }).forEach(function (itm, i) {
      if (itm.length === 1) {
        var strItm = "0".concat(itm);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_tabcontent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/tabcontent */ "./js/modules/tabcontent.js");
/* harmony import */ var _modules_calc_second_edittion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/calc_second_edittion */ "./js/modules/calc_second_edittion.js");
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/cards */ "./js/modules/cards.js");
/* harmony import */ var _modules_slider_geometry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider_geometry */ "./js/modules/slider_geometry.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var date = '2020-12-31'; // const tabs = require('./modules/tabcontent'),
  ...
  (0,_modules_tabcontent__WEBPACK_IMPORTED_MODULE_0__.tabs)('.tabheader__items', '.tabheader__item', '.tabcontent', '.tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__.modal)();
  (0,_modules_calc_second_edittion__WEBPACK_IMPORTED_MODULE_1__.calc)();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__.cards)();
  (0,_modules_slider_geometry__WEBPACK_IMPORTED_MODULE_3__.slider)({
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__.timer)('#days', '#hours', '#minutes', '#seconds', '.promotion__timer', '.title', date);
});
...
/* harmony export */   "getResFromDB": function() { return /* binding */ getResFromDB; }
/* harmony export */ });
...
var getResFromDB = /*#__PURE__*/function () {
  ...
  return function getResFromDB(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
